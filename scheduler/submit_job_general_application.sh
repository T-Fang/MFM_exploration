...
python_env=tz_py39_gpu

dataset_name=HCPYA  # ['HCPYA', 'PNC']
main_py=main_${dataset_name}.py

target='only1_group'
# ['only1_group', 'age_group', 'overall_acc_group_high/low', 'group_dl_dataset', 'individual']
mode='test'
# ['train', 'validation', 'test', 'simulate_fc_fcd', 'EI', 'val_train_param', 'simulate_fc']
need_gpu=0

logpath="/home/tzeng/storage/Python/MFMApplication/logs/${dataset_name}_logs/${target}/${mode}"
...
# For group
if [ ${target} = 'only1_group' ]  # No group_nbr need
then
    ...
    then
        ...
        for trial_nbr in "${trial_list[@]}"
        do
            logdir="${logpath}/trial${trial_nbr}"
            mkdir -p ${logdir}

            for seed_nbr in "${seed_list[@]}"
            do
                logerror="se${seed_nbr}_error.log"
                log_out="se${seed_nbr}_out.log"
                cmd="source activate ${python_env}; cd /home/tzeng/storage/Python/MFMApplication/scripts; python -u ${main_py} $trial_nbr $seed_nbr"
        ...
        do
            ...
            do
                ...
                do
                    ...
                    cmd="source activate ${python_env}; cd /home/tzeng/storage/Python/MFMApplication/scripts; python -u ${main_py} ${trial_nbr} ${seed_nbr} ${epoch}"
                    ...
                    if [ ${epoch} == '0' ]  # For tackling conflicts of directory making
                    then
                        sleep 5
                    fi
    ...
    elif [[ ${mode} = 'test' || ${mode} = 'simulate_fc_fcd' ]]
    then
...
elif [[ ${target} = 'age_group' || ${target} = 'overall_acc_group_high' ||  ${target} = 'overall_acc_group_low' || ${target} = 'group_dl_dataset' ]]
# Need to check final state manually.
then

    if [ ${mode} = 'train' ]
    then
        # whole group range ($(seq 1 1 29)); ($(seq 1 1 14))  ($(seq 0 1 63))
        ...
        do
            ...
            do
                ...
                do
                    ...
                    if [ ${need_gpu} = 1 ]
                    then
                        cmd="module load cuda/11.7; source activate ${python_env}; cd /home/tzeng/storage/Python/MFMApplication/scripts; python -u ${main_py} $group_nbr $trial_nbr $seed_nbr"
                    ...
                    then
                        cmd="source activate ${python_env}; cd /home/tzeng/storage/Python/MFMApplication/scripts; python -u ${main_py} $group_nbr $trial_nbr $seed_nbr"
            ...
            do
                ...
                do
                    ...
                    do
                        ...
                        cmd="source activate ${python_env}; cd /home/tzeng/storage/Python/MFMApplication/scripts; python -u ${main_py} $group_nbr $trial_nbr $seed_nbr $epoch"
        ...
        do
            ...
            do
                ...
                do
                    ...
                    cmd="source activate ${python_env}; cd /home/tzeng/storage/Python/MFMApplication/scripts; python -u ${main_py} $sub_nbr $trial_nbr $seed_nbr"
        ...
        do
            ...
            do
                ...
                do
                    ...
                    cmd="source activate ${python_env}; cd /home/tzeng/storage/Python/MFMApplication/scripts; python -u ${main_py} $sub_nbr ${trial_nbr} ${epoch}"
    ...
    then
        ...
        do
            ...
            do
                ...
                cmd="source activate ${python_env}; cd /home/tzeng/storage/Python/MFMApplication/scripts; python -u ${main_py} $sub_nbr ${trial_nbr}"
