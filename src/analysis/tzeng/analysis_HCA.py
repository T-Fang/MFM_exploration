...
def plot_pred_loss(nbr=None):
    ...
    trial_nbr = 5
    param_save_dir = f'/home/tzeng/storage/Python/MFMApplication/Params/HCAParams/{target}/train/trial{trial_nbr}/{prefix}{nbr}'
    figure_save_path = f'/home/tzeng/storage/Python/MFMApplication/Params/HCAParams/{target}/figures/pred_loss/trial{trial_nbr}_{prefix}{nbr}.png'
...
def check_dl_epochs():
    trial_nbr = 1
    nbr = 1
    parent_dir = '/home/tzeng/storage/Python/MFMApplication/Params/HCAParams/group'
...
def find_fail_trial():
    trial_nbr = 4
    train_dir = f'/home/tzeng/storage/Python/MFMApplication/Params/HCAParams/group/train/trial{trial_nbr}'
    for nbr in range(1, 30):
        train_final_state = os.path.join(train_dir, f'group{nbr}/param_save_epoch0.pth')
...
def age_distribution():
    ...
    plt.xlabel('Age/year')
    plt.ylabel('number')
    plt.savefig('/home/tzeng/storage/Python/MFMApplication/figures/dataset_related/HCA_age_dist.png')
    plt.close()
    print("Done.")
...
def plot_EI_ratio_group():
    trial_nbr = 5
    EI_dir = f'/home/tzeng/storage/Python/MFMApplication/Params/HCAParams/group/EI_ratio/trial{trial_nbr}'
    save_fig_path = f'/home/tzeng/storage/Python/MFMApplication/Params/HCAParams/group/figures/EI/trial{trial_nbr}_development_fit.png'
