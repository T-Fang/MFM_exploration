...
boxplot([total_cost_pFIC' total_cost_rsfc' total_cost_myelin' total_cost_homo'],'Colors', 'k', 'Labels', {'pFIC', 'RSFC gradient', 'T1w/T2w', 'homogeneous'});
ylim([0.5 2.1])
